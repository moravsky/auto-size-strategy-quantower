...
- **Prop firm drawdown modes** - supports trailing intraday drawdown, end-of-day drawdown, and static cash accounts.
...
- **Execution costs** - commission and slippage baked into sizing math per instrument.
...
**To run:**
- [Quantower](https://www.quantower.com/) with an active connection (any futures broker)
...
Download `AutoSizeStrategy-Setup-x.x.x.exe` from [Releases](https://github.com/moravsky/auto-size-strategy/releases). Run it - it auto-detects your Quantower installation path.
...
3. In the settings panel, configure:
   ...
   - **Drawdown Mode** - `Intraday`, `End of Day`, `Static` for cash accounts
   - **Minimum Balance Override** - required for End of Day mode (set to your account's bust threshold)
...
If you scale out of a position partially or move your stop loss, your VaR instantly changes to reflect your new risk. If you accidentally leave any open position unprotected (no stop loss or doesn't cover full position), VaR immediately spikes to 100% of your max account exposure. 

*Visible in the Quantower Strategy Metrics panel, updated every second.*

---

## Author

**Petr Moravsky** - futures trader and developer.

[petr@moravsky.net](mailto:petr@moravsky.net) | [github.com/moravsky](https://github.com/moravsky)

If AutoSizeStrategy helped you pass an eval, size live account trades, or served as a reference for your own development - [tips are appreciated](https://ko-fi.com/moravsky).
